-- ============================================================
-- Migration 019: Upgrade/change subscription plan with payment
-- RPC for logged-in proprietors to upgrade their subscription
-- after paying via Flutterwave.
-- ============================================================
...
BEGIN
  ...
  -- Update the subscription: change plan + renew period
