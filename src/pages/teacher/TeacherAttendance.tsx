...
export default function TeacherAttendance() {
  ...
  // Only show teacher's own classes (school-scoped)
  ...
  const saveMutation = useMutate(
    () => attendanceService.markAttendance(selectedClass, selectedDate, Array.from(entries.values()), teacherId),
    [['attendance', selectedClass, selectedDate]],
    {
      ...
      {!selectedClass ? (
        <Card>
          <CardContent className="flex flex-col items-center py-16 text-center">
            ...
            <p className="text-sm text-slate-400">Select one of your classes to mark attendance.</p>
          </CardContent>
        </Card>
      ) : studentsLoading ? (
