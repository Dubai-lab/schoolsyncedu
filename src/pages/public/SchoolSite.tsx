      ...
      >
        <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-3.5 sm:px-8">
          ...
          <div className="flex items-center gap-3">
            {school.logo_url ? (
              <img src={school.logo_url} alt={school.name} className="h-14 w-14 rounded-xl object-contain bg-white p-0.5 shadow-sm" />
            ) : (
        ...
        <div className="mx-auto max-w-7xl px-5 py-14 sm:px-8">
          <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="sm:col-span-2 lg:col-span-1">
              <div className="flex items-center gap-3">
                {school.logo_url ? (
                  <img src={school.logo_url} alt={school.name} className="h-14 w-14 rounded-xl object-contain bg-white p-0.5" />
                ) : (
