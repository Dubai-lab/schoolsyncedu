...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Semesters & Periods', path: '/classes/terms', icon: Calendar, roles: [USER_ROLES.PRINCIPAL, USER_ROLES.VICE_PRINCIPAL, USER_ROLES.IT_ADMIN] },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Messages', path: '/admin/messages', icon: MessageSquare, roles: [USER_ROLES.SUPER_ADMIN] },
